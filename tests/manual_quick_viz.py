...
try:
    server_thread = start_visualization_server(host="127.0.0.1", port=8080, open_browser=False)
    ...
    # Send a test update
    viz.update_training_step(loss=2.5, learning_rate=1e-4, batch=None, outputs=None, optimizer=None)
